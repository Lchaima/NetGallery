        ...
        <figure>
          ...
          $result1 = $mysqli->query($requete1);
            ...
            else 
            {
                  ...
                  echo("<figure>") ;	
                  echo('<a class="imgover" href="https://obiwan2.univ-brest.fr/licence/lic245/v1/pages/oeuvre.php?id='.$oev['oev_id'].'"><img src="../images/demo/gallery/oeuvres/'.$oev['oev_image'].'"'.'style="width:350px;height:300px;"></a>');
                  echo ("<figcaption>") ;
