  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <figcaption class="sectiontitle">
        <h1 class="heading underline font-x2"> Livre d'or <h1> 
        </figcaption>
         <table>
          <thead>
           <tr>
      ...
      <div id="comments">
        ...
        <form action="commentaire_action.php" method="post">
          <div class="one_third first">
            <label for="numero"> numéro de ticket <span>*</span></label>
            <input type="text" name="numero" id="numero" value="" size="22" required>
          </div>
          <div class="one_third">
            <label for="mdp"> mot de passe  <span>*</span></label>
            <input type="password" name="mdp" id="mdp" value="" size="22" required>
          </div>
          <div class="one_third first">
            <label for="nom"> nom <span>*</span> </label>
            <input type="texte" name="nom" id="nom" value="" size="22">
          </div>
          <div class="one_third">
            <label for="prenom"> prenom <span>*</span></label>
            <input type="texte" name="prenom" id="prenom" value="" size="22">
          </div>
          <div class="one_third">
